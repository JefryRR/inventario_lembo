...
export default function MortalidadCreate() {
	...
	return (
		<>
			<PageMeta title="Registrar mortalidad | Inventario Lembo" description="Formulario para registrar mortalidad en un lote" />
			<PageBreadcrumb pageTitle="Registrar mortalidad" />
